...
{
    class NAudioEngine : INotifyPropertyChanged, IDisposable
    {
        #region Fields
        private static NAudioEngine instance;
        public readonly BackgroundWorker waveformGenerateWorker = new BackgroundWorker();
        ...
        private void GenerateWaveformData(string path)
        {
            ...
            {
                DoWorkEventArgs doWorkEventArgs = new DoWorkEventArgs(new WaveformGenerationParams(waveformCompressedPointCount, path));
                waveformGenerateWorker_DoWork((object)1, doWorkEventArgs);
            }
        }
